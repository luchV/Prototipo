    ...
    <div class="Menus-create">
        <div class="col-md-12" id="btn_next" style="display:none;">
            ...
            <div class="form-group" style="text-align: end !important;">
                <?= Html::submitButton(Yii::t('app', $textoBotton . ' <em class="fas fa-arrow-right"></em>'), ['class' => 'btn btn-primary text-center', 'onclick' => $funcionEnvioRespuestas . '("sonidosiniciales","' . $accion . '","' . $modelSeccion->secTipoRespuesta . '","solo")']) ?>
            </div>
        </div>
        <div class="name-tag">
            <h1><?= $this->title ?></h1>
