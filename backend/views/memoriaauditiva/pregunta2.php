...
<div id="contenedor-Preguntas">
    ...
    <button class="btn btn-primary text-center" id="btmContinuar" onclick="siguientePregunta3(<?= count($modelRespuestas) ?>,'<?= $modelSeccion->secTipoRespuesta ?>')"> Continuar <em class="fas fa-arrow-right"></em></button>
</div>
