...
<div id="contenedor-Preguntas">
    ...
    <div class="Menus-create">
        ...
        <?= IntentaloNuevamente::widget([
            'funcionRepetir' => 'repetirImagenes4',
            'numeroTotal' => count($modelRespuestas),
            'TipoRespuestas' => $modelSeccion->secTipoRespuesta
        ]);
        ?>
    </div>
    <button class="btnPersonalizado" id="btmSubPregunta" onclick="reproducirAudioCargado('audioSupPegunta','iconoButtonSubPregunta','fas fa-volume-off','fas fa-volume-up')"><em id="iconoButtonSubPregunta" class="fas fa-volume-off"></em></button>
    </br>
    </br>
    <button class="btn btn-primary text-center" id="btmContinuar" onclick="siguientePregunta2(<?= count($modelRespuestas) ?>,'<?= $modelSeccion->secTipoRespuesta ?>')"> Continuar <em class="fas fa-arrow-right"></em></button>
</div>
